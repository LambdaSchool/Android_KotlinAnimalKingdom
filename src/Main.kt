fun main(){
  val animals = seedData()
     ...
     animals.filter { (it.breatheType.breath.equals(BreatheType.LUNGS.breath) && it.year.equals(1758)) }
          .forEach { println(it) }
     println("\n-----Animals that lay eggs and breathe using lungs-----\n")
     animals.filter {
          (it.breatheType.breath.equals(BreatheType.LUNGS.breath) && it.reproduceType.reproduce.equals(
